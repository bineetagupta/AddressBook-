			 ...
			 <form id="addContact" action="#" method="post" >
					...
					<div class="row">
						<div class="large-4 columns">
							<label> Email
								<input name="email" type="text" placeholder="Enter Email Name" />
							</label>
						</div>
					...
					<div class="row">
						...
						<div class="large-6 columns">
							<label>Address1
								<input name="address1" type="text" placeholder="Enter Address1" />
							</label>
						</div>
						
						<div class="large-6 columns">
							<label>Address2
								<input name="address2" type="text" placeholder="Enter Address2" />
							</label>
						</div>
					</div>
